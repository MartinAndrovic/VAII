...
Route::post('/skuska/start',[App\Http\Controllers\SkuskyController::class, 'storeEx']);

Route::get('/skuska/riesenie/{riesenie}',[App\Http\Controllers\SkuskyController::class, 'showR']);
